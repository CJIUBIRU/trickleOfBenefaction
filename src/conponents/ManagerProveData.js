...
function OrgData({name, status, mail, demandPurpose, authority, managerName, managerPhone, registAdd, contactAdd, affidavit, permit, certificate}) {
    ...
    return (
        <Card.Body>
            ...
            <ol style={{ lineHeight: "45px", paddingLeft: "50px" }}>
                <li><span style={{ color: "#90AACB", cursor: "pointer" }}>{certificate}&nbsp;<FontAwesomeIcon icon={faCloudDownload} /></span></li>
                <li><span style={{ color: "#90AACB", cursor: "pointer" }}>{affidavit}&nbsp;<FontAwesomeIcon icon={faCloudDownload} /></span></li>
                <li><span style={{ color: "#90AACB", cursor: "pointer" }}>{permit}&nbsp;<FontAwesomeIcon icon={faCloudDownload} /></span></li>
            </ol>
            <div style={btnStyle}>
...
function ManagerProveData() {
    ...
    useEffect(() => {
        ...
        const q = query(collection(db, 'charity'), where('info.name', '==', org.name))
