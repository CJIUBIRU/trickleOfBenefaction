...
import { faPaperclip, faPlus, faTrashCan } from "@fortawesome/free-solid-svg-icons";
      ...
      <Table bordered hover size="sm">
        <tbody>
          <tr>
            ...
            <td style={{ width: "10%", textAlign: "center" }}><FontAwesomeIcon style={{color: "#e74a3a"}} icon={faTrashCan} /></td>
